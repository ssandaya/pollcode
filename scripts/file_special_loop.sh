...
# WIN_DESTINATION_DIR="c:/cygwin64/home/simulate/proc/polldata/gurps_005083109191_$(date +%Y%m%d)/"
WIN_DESTINATION_DIR="c:/cygwin64/home/simulate/proc/polldata/gurps_9191_1111-$(date +%Y%m%d)/"
...
do
  ...
  cd ${dir##*/}
  for subdir in i@67* //i@68* i@AM* i@T* 
  do 
    pwd
    subdir=${subdir%*/}
    # echo ${subdir##*/}
